...
public class InventoryDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<InventoryItem> items = List.of(
                ...
                new InventoryItem("PROD-DRILL-001", "DeWalt 20V Cordless Drill",
                        "POWER_TOOLS", 50, "AISLE-A1"),
                new InventoryItem("PROD-SAW-002", "Circular Saw 7-1/4 inch",
                        "POWER_TOOLS", 30, "AISLE-A2"),

                // Plumbing — mixed stock
                new InventoryItem("PROD-PIPE-010", "3/4 inch Copper Pipe (10ft)",
                        "PLUMBING", 200, "AISLE-B1"),
                new InventoryItem("PROD-VALVE-011", "Ball Valve 1/2 inch",
                        "PLUMBING", 3, "AISLE-B2"),  // ← low stock — triggers INSUFFICIENT

                // Electrical
                new InventoryItem("PROD-WIRE-020", "12 AWG Electrical Wire (100ft)",
                        "ELECTRICAL", 75, "AISLE-C1"),
                new InventoryItem("PROD-PANEL-021", "20A Circuit Breaker",
                        "ELECTRICAL", 40, "AISLE-C2"),

                // Fasteners — high volume
                new InventoryItem("PROD-NAIL-030", "Framing Nails 3.5 inch (5lb)",
                        "FASTENERS", 500, "AISLE-D1"),
                new InventoryItem("PROD-SCREW-031", "Deck Screws #10 x 3in (100pk)",
                        "FASTENERS", 300, "AISLE-D2"),

                // Lumber — low stock to show failures
                new InventoryItem("PROD-LUMB-040", "2x4x8 Pressure Treated Lumber",
                        "LUMBER", 2, "YARD-E1"),     // ← low stock — triggers INSUFFICIENT
                new InventoryItem("PROD-PLY-041", "3/4 inch Plywood Sheet",
                        "LUMBER", 20, "YARD-E2")
        );
